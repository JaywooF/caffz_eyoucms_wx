...
Page({
  ...
  getArchivesView() {
    ...
    App._requestApi(_this, App.globalData.config.apiViewUrl, {
      ...
      preDetail = "preDetail" in res.data.apiPrenext[1] ? res.data.apiPrenext[1].preDetail :{}, // 上一篇文档的数据
      nextDetail = "nextDetail" in res.data.apiPrenext[1] ? res.data.apiPrenext[1].nextDetail : {}; // 下一篇文档的数据
